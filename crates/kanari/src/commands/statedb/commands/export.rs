...
pub enum ExportMode {
    #[default]
    Genesis, // dump InscriptionStore, BitcoinUTXOStore, KanariToBitcoinAddressMapping for genesis start-up
    Full,
    Snapshot,
...
impl ExportObjectName {
    pub fn object_id(&self) -> Option<ObjectID> {
        match self {
            ...
            ExportObjectName::AddressMap => Some(KanariToBitcoinAddressMapping::object_id()),
    ...
    pub fn from_object_id(object_id: ObjectID) -> Self {
        ...
        } else if object_id == KanariToBitcoinAddressMapping::object_id() {
...
pub struct ExportCommand {
    ...
    #[clap(long, short = 'o')]
    /// export output file. like ~/.kanari/local/statedb.csv or ./statedb.csv
...
impl ExportCommand {
    ...
    fn export_address_map(
        ...
        let object_id = KanariToBitcoinAddressMapping::object_id();
        let object_name = ExportObjectName::from_object_id(object_id.clone()).to_string();
