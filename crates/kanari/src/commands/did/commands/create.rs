...
impl CommandAction<CreateOutput> for CreateCommand {
    async fn execute(self) -> KanariResult<CreateOutput> {
...
fn extract_new_did_object_id(
...
) -> KanariResult<moveos_types::moveos_std::object::ObjectID> {
    ...
    Err(kanari_types::error::KanariError::CommandArgumentError(
