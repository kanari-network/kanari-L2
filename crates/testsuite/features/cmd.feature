Feature: Kanari CLI integration tests

    @serial
    Scenario: kanari rpc test
      Given a server for kanari_rpc_test
      Then cmd: "rpc request --method kanari_getStates --params '["/resource/0x3/0x3::account_coin_store::AutoAcceptCoins", {"decode":true}]' --json"
      ...
      Then cmd: "rpc request --method kanari_getStates --params '["/object/0x3", {"decode":true}]' --json"
      Then assert: "{{$.rpc[-1][0].object_type}} == '0x2::account::Account'"
      Then cmd: "rpc request --method kanari_listStates --params '["/resource/0x3", null, null, {"decode":true}]' --json"
      ...
      Then cmd: "rpc request --method kanari_getStates --params '["/object/0x3a7dfe7a9a5cd608810b5ebd60c7adf7316667b17ad5ae703af301b74310bcca", {"decode":true}]' --json"
      Then assert: "{{$.rpc[-1][0].object_type}} == '0x2::timestamp::Timestamp'"
      Then assert: "{{$.rpc[-1][0].decoded_value.value.milliseconds}} == 0"
      Then cmd: "rpc request --method kanari_getStates --params '["/object/0x2::timestamp::Timestamp",{"decode":true}]' --json"
      Then assert: "{{$.rpc[-1][0].object_type}} == '0x2::timestamp::Timestamp'"
      Then cmd: "rpc request --method kanari_getObjectStates --params '["0x3a7dfe7a9a5cd608810b5ebd60c7adf7316667b17ad5ae703af301b74310bcca", {"decode":false}]' --json"
      Then cmd: "rpc request --method kanari_getObjectStates --params '["0x3a7dfe7a9a5cd608810b5ebd60c7adf7316667b17ad5ae703af301b74310bcca", {"decode":true}]' --json"
      Then assert: "{{$.rpc[-1][0].object_type}} == '0x2::timestamp::Timestamp'"
      ...
      # 0x3 is the kanari_framwork package address, the package's field key is the package address.
      Then cmd: "rpc request --method kanari_getFieldStates --params '["0x2::module_store::ModuleStore", ["0x3"], {"decode": true, "showDisplay": true}]' --json"
      Then assert: "{{$.rpc[-1][0].object_type}} == '0x2::module_store::Package'"
      Then cmd: "rpc request --method kanari_listFieldStates --params '["0x14481947570f6c2f50d190f9a13bf549ab2f0c9debc41296cd4d506002379659", null, "2", {"decode": false, "showDisplay": false}]' --json"
      Then assert: "{{$.rpc[-1].has_next_page}} == true"
      Then cmd: "rpc request --method kanari_getModuleABI --params '["0x2", "display"]'"
    ...
    Scenario: account
      ...
      Then cmd: "rpc request --method kanari_getBalance --params '["{{$.address_mapping.default}}", "0x3::gas_coin::RGas"]' --json"
      Then assert: "'{{$.rpc[-1].coin_type}}' == '0x3::gas_coin::RGas'"
      Then assert: "'{{$.rpc[-1].balance}}' == '0'"

      # Get gas
      Then cmd: "move run --function kanari_framework::gas_coin::faucet_entry --args u256:10000000000 --json"
      ...
      # session key
      Then cmd: "session-key create  --app-name test --app-url https:://test.kanari.network --scope 0x3::empty::empty"
      ...
      Then cmd: "transaction build --function kanari_framework::empty::empty --json"
      ...
      Then cmd: "account balance --coin-type kanari_framework::gas_coin::RGas"
      Then cmd: "rpc request --method kanari_getBalance --params '["{{$.address_mapping.default}}", "0x3::gas_coin::RGas"]' --json"
      Then assert: "'{{$.rpc[-1].balance}}' != '0'"
    ...
    Scenario: state
      ...
      Then cmd: "state --access-path /object/0x3::address_mapping::kanariToBitcoinAddressMapping"
      Then assert: "{{$.state[-1][0].object_type}} == '0x3::address_mapping::kanariToBitcoinAddressMapping'"
    ...
    Then cmd: "move publish -p ../../examples/event  --named-addresses kanari_examples=default --json"
    Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
  ...
  Scenario: indexer
    ...
    Then cmd: "rpc request --method kanari_queryTransactions --params '[{"tx_order_range":{"from_order":0,"to_order":2}}, null, "1", {"descending": true,"showDisplay":false}]' --json"
    Then assert: "{{$.rpc[-1].data[0].transaction.sequence_info.tx_order}} == 1"
    Then assert: "{{$.rpc[-1].next_cursor}} == 1"
    Then assert: "{{$.rpc[-1].has_next_page}} == true"
    Then cmd: "rpc request --method kanari_queryTransactions --params '[{"tx_order_range":{"from_order":0,"to_order":2}}, "1", "1", {"descending": true,"showDisplay":false}]' --json"
    ...
    Then cmd: "rpc request --method kanari_queryEvents --params '[{"tx_order_range":{"from_order":0, "to_order":2}}, null, "30", {"descending": true,"showDisplay":false}]' --json"
    ...
    Then cmd: "rpc request --method kanari_listFieldStates --params '["{{$.address_mapping.default}}", null, "10", {"descending": true,"showDisplay":false}]' --json"
    Then assert: "{{$.rpc[-1].has_next_page}} == false"

#    Then cmd: "rpc request --method kanari_syncStates --params '[null, null, "2", false]' --json"
...
#    Then assert: "{{$.rpc[-1].has_next_page}} == true"
  ...
  Scenario: sync_states_filter
      ...
      Then cmd: "rpc request --method kanari_syncStates --params '[{\"object_i_d\":\"{{$.event[-1].data[0].decoded_event_data.value.id}}\"}, null, \"10\", {\"descending\":false}]' --json"
      ...
      Then cmd: "rpc request --method kanari_syncStates --params '[{\"object_i_d\":\"0x1234567890123456789012345678901234567890123456789012345678901234\"}, null, \"10\", {\"descending\":false}]' --json"
  ...
  @serial
    Scenario: kv_store example
      ...
      Then cmd: "move publish -p ../../examples/kv_store  --named-addresses kanari_examples=default --json"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
    ...
    Scenario: entry_function example
      ...
      Then cmd: "move publish -p ../../examples/entry_function_arguments/  --named-addresses kanari_examples=default --json"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
  ...
  Scenario: publish through MoveAction and module upgrade
      ...
      # The counter example
      Then cmd: "move publish -p ../../examples/counter  --named-addresses kanari_examples=default --by-move-action --json"
  ...
  Scenario: publish_through_entry_function publish through Move entry function and module upgrade
      ...
      Then cmd: "move build -p ../../examples/counter  --named-addresses kanari_examples=default --json"
      ...
      Then cmd: "move publish -p ../../examples/entry_function_arguments_old/  --named-addresses kanari_examples=default --json"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
      Then cmd: "move run --function default::entry_function::emit_mix --args 3u8 --args "vector<object_id>:0x2342,0x3132"  --json"
      ...
      # check compatibility
      Then cmd: "move publish -p ../../examples/entry_function_arguments_old/  --named-addresses kanari_examples=default --skip-client-compat-check --json"
  ...
  Scenario: coins example
      ...
      Then cmd: "rpc request --method kanari_getBalance --params '["{{$.account[-1].default.bitcoin_address}}", "{{$.account[-1].default.hex_address}}::fixed_supply_coin::FSC"]' --json"
      Then assert: "'{{$.rpc[-1].coin_type}}' == '{{$.address_mapping.default}}::fixed_supply_coin::FSC'"
      Then assert: "'{{$.rpc[-1].balance}}' != '0'"

      Then cmd: "rpc request --method kanari_getBalance --params '["{{$.account[-1].default.nostr_public_key}}", "{{$.account[-1].default.hex_address}}::fixed_supply_coin::FSC"]' --json"
      Then assert: "'{{$.rpc[-1].coin_type}}' == '{{$.address_mapping.default}}::fixed_supply_coin::FSC'"
      Then assert: "'{{$.rpc[-1].balance}}' != '0'"
  ...
  Scenario: Issue a coin through module_template
    ...
    Then cmd: "move publish -p ../../examples/module_template/  --named-addresses kanari_examples=default --json"
    Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
    ...
    #Then cmd: "rpc request --method kanari_getBalance --params '["{{$.address_mapping.default}}", "{{$.address_mapping.default}}::my_coin::MyCoin"]' --json"
  ...
  Scenario: object display example
      ...
      Then cmd: "rpc request --method kanari_getStates --params '["/object/{{$.event[-1].data[0].decoded_event_data.value.id}}", {"decode": false, "showDisplay": true}]' --json"
      Then assert: "{{$.rpc[-1][0].display_fields.fields.name}}  == test_object"

      # because the indexer is async update, so sleep 2 seconds to wait indexer update.
      Then sleep: "2"

      Then cmd: "rpc request --method kanari_queryObjectStates --params '[{"object_type":"{{$.address_mapping.default}}::display::ObjectType"}, null, "10", {"descending": false,"showDisplay":true}]' --json"
      ...
      Then cmd: "rpc request --method kanari_getObjectStates --params '["{{$.event[-1].data[0].decoded_event_data.value.id}}", {"decode": false, "showDisplay": true}]' --json"
      Then assert: "{{$.rpc[-1][0].display_fields.fields.name}} == test_object"
    ...
    Scenario: wasm test
      ...
      Then cmd: "move publish -p ../../examples/wasm_execution  --named-addresses kanari_examples=default --json --max-gas-amount=1000000000"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
    ...
    Scenario: cosmwasm-vm test
      ...
      # publish wasm execution
      Then cmd: "move publish -p ../../examples/cosmwasm_vm_execution  --named-addresses kanari_examples=default --json --max-gas-amount=1000000000"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
  ...
  @serial
    Scenario: view_function_loop example
      ...
      Then cmd: "account create"
      Then cmd: "move publish -p ../../examples/view_function_loop  --named-addresses kanari_examples=default --json"
      Then assert: "{{$.move[-1].execution_info.status.type}} == executed"
