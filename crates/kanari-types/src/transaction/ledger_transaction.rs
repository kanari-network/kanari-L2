...
use super::{KanariTransaction, TransactionSequenceInfo};
...
impl LedgerTxData {
    ...
    pub fn sender(&self) -> Option<KanariAddress> {
        match self {
...
impl LedgerTransaction {
    ...
    pub fn new_l2_tx(tx: KanariTransaction, sequence_info: TransactionSequenceInfo) -> Self {
        Self {
    ...
    pub fn sign_tx_order(tx_order: u64, tx_hash: H256, sequencer_key: &KanariKeyPair) -> Vec<u8> {
