...
impl MoveStructType for EthereumValidator {
    const ADDRESS: AccountAddress = KANARI_NURSERY_ADDRESS;
...
/// Rust bindings for Kanari Framework ethereum_validator module
...
impl<'a> ModuleBinding<'a> for EthereumValidatorModule<'a> {
    ...
    const MODULE_ADDRESS: AccountAddress = KANARI_NURSERY_ADDRESS;
