...
pub const MESSAGE_INFO: &[u8] = b"Kanari Transaction:\n";
...
impl SignData {
    ...
    pub fn new_with_default(tx_data: &KanariTransactionData) -> Self {
...
impl AuthPayload {
    ...
    pub fn verify(&self, tx_data: &KanariTransactionData) -> Result<()> {
...
mod tests {
    ...
    use crate::{
        ...
        transaction::{Authenticator, KanariTransactionData},
    };
