...
/// Rust bindings for KanariFramework account_authentication::AuthenticationKey
...
/// Rust bindings for KanariFramework account_authentication module
...
impl<'a> ModuleBinding<'a> for AuthenticationKeyModule<'a> {
    const MODULE_NAME: &'static IdentStr = ident_str!("account_authentication");
