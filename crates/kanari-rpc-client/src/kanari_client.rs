...
impl KanariRpcClient {
    ...
    pub async fn get_sequence_number(&self, sender: KanariAddress) -> Result<u64> {
        Ok(self
            .get_states(
    ...
    pub async fn get_balance(
        &self,
        account_addr: KanariAddressView,
