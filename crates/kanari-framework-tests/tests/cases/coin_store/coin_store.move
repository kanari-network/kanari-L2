...
script {
    ...
    use kanari_framework::coin_store::CoinStore;
    use kanari_framework::gas_coin::RGas;
    ...
    fun main(sender: &signer) {
        ...
        std::debug::print(&kanari_framework::coin::is_registered<RGas>());
        std::debug::print(&kanari_framework::account_coin_store::balance<RGas>(account_addr));
    }
}

//Get gas from faucet
//# run kanari_framework::gas_coin::faucet_entry --signers test --args u256:100000000000
...
script {
    ...
    use kanari_framework::gas_coin::{Self};
