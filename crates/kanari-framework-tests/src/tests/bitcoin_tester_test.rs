...
use kanari_types::bitcoin::ord::{Inscription, InscriptionID, SatPoint};
use std::str::FromStr;
...
// https://github.com/kanari-network/kanari/issues/1985

// cargo run -p kanari-framework-tests --  --btc-rpc-url http://localhost:8332 --btc-rpc-username your_username --btc-rpc-password your_pwd --blocks 790964 --blocks 855396
