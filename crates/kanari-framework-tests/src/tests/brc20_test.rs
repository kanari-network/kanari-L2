...
fn decode_tx(btx_tx_hex: &str) {
    ...
    //let brc20_module = binding_test.as_module_binding::<kanari_types::bitcoin::brc20::BRC20Module>();
    //let move_btc_tx: kanari_types::bitcoin::types::Transaction = btc_tx.into();
