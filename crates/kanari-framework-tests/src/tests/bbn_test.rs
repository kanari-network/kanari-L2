...
//cargo run -p kanari-framework-tests --  --btc-rpc-url http://localhost:8332 --btc-rpc-username your_username --btc-rpc-password your_pwd --blocks 864790 --bbn-staking-tx-csv /path/to/bbn_staking_tx.csv
// #[tokio::test]
...
async fn test_bbn_tx() {
    ...
    let bbn_module = binding_test.as_module_binding::<kanari_types::bitcoin::bbn::BBNModule>();
