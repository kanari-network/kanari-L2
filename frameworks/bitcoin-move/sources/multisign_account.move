...
module bitcoin_move::multisign_account{
    ...
    struct MultisignAccountInfo has key, store {
        /// The multisign account kanari address
    ...
    public fun initialize_multisig_account(
        ...
        let multisign_address = bitcoin_address::to_kanari_address(&multisign_bitcoin_address);
        ...
        while(idx < len){
            ...
            let participant_address = bitcoin_address::to_kanari_address(&participant_bitcoin_address);
