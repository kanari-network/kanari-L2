...
module bitcoin_move::genesis{
    ...
    const ErrorInvalidKanariDaoAddress: u64 = 2;
    ...
    fun init(){
        ...
        let kanari_dao_address = multisign_account::initialize_multisig_account(genesis_context.kanari_dao.threshold, genesis_context.kanari_dao.participant_public_keys);
        assert!(kanari_dao_address == bitcoin_address::to_kanari_address(&genesis_context.kanari_dao.multisign_bitcoin_address), ErrorInvalidKanariDaoAddress);
    }
    ...
    public fun init_for_test(){
        ...
        tx_context::add_attribute_via_system(&genesis_account, 
            BitcoinGenesisContext{
                ...
                reorg_block_count: 0,
                kanari_dao: MultisignAccountConfig{
                    multisign_bitcoin_address: kanari_framework::bitcoin_address::from_string(&std::string::utf8(b"bc1pevdrc8yqmgd94h2mpz9st0u77htmx935hzck3ruwsvcf4w7wrnqqd0yvze")),
                    threshold: 1,
