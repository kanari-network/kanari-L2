...
module bitcoin_move::bbn {
    ...
    fun process_parsed_bbn_tx(param: &BBNGlobalParamV1, txid: address, block_height: u64, tx: &Transaction, op_return_output: BBNOpReturnOutput): Result<ObjectID, String> {
        ...
        let staker_address = pubkey_to_kanari_address(&op_return_data.staker_pub_key);
    ...
    fun pubkey_to_kanari_address(pubkey: &vector<u8>): address {
        to_kanari_address(&derive_bitcoin_taproot_address_from_pubkey(pubkey))
    }
