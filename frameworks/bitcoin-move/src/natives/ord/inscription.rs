...
impl From<Envelope<Inscription>>
    for kanari_types::bitcoin::ord::Envelope<kanari_types::bitcoin::ord::InscriptionRecord>
{
...
impl From<Inscription> for kanari_types::bitcoin::ord::InscriptionRecord {
    fn from(val: Inscription) -> Self {
        ...
        kanari_types::bitcoin::ord::InscriptionRecord {
