...
module kanari_nursery::tick_info {
    ...
    use kanari_nursery::bitseed::{Self, Bitseed};
    ...
    friend kanari_nursery::inscribe_factory;
    ...
    struct TickInfo has key {
        ...
        /// The mint factory of the tick on Kanari
        /// If mint factory is Some, means the tick is issued on Kanari.
