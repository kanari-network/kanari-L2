...
module moveos_std::cbor {
    ...
    fun test_to_cbor() {
        let test = Test { 
            ...
            ascii_string: std::ascii::string(b"kanari.site"),
            utf8_string: std::string::utf8(b"kanari.site"),
            null_value: option::none(),
            option_string: option::some(std::string::utf8(b"kanari.site")),
            inner: Inner {
                value: 100u64,
            },
    ...
    fun test_from_cbor() {
        ...
        // check ascii string
        assert!(obj.ascii_string == std::ascii::string(b"kanari.site"), 12);

        // check utf8 string
        assert!(obj.utf8_string == std::string::utf8(b"kanari.site"), 13);
        ...
        assert!(option::borrow(&obj.option_string) == &std::string::utf8(b"kanari.site"), 20);
    }
    ...
    fun test_to_map(){
        ...
        assert!(ascii_string == std::ascii::string(b"kanari.site"), 2);
        ...
        assert!(utf8_string == std::string::utf8(b"kanari.site"), 3);
        ...
        assert!(option::borrow(&option_string) == &std::string::utf8(b"kanari.site"), 18);
