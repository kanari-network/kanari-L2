...
module moveos_std::json{
    ...
    #[test]
    fun test_from_json() {
        let json_str = b"{\"balance\": \"170141183460469231731687303715884105728\",\"utf8_string\":\"kanari.network\",\"age\":30,\"inner\":{\"value\":100},\"bytes\":[3,3,2,1],\"inner_array\":[{\"value\":101}],\"account\":\"kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd\"}";
    ...
    #[test]
    fun test_to_map(){
        let json_str = b"{\"balance\": \"170141183460469231731687303715884105728\",\"string\":\"kanari.network\",\"age\":30,\"bool_value\": true, \"null_value\": null, \"account\":\"0x42\", \"inner\":{\"value\":100},\"bytes\":[3,3,2,1],\"inner_array\":[{\"value\":101}]}";
        ...
        assert!(simple_map::borrow(&map, &string::utf8(b"string")) == &string::utf8(b"kanari.network"), 2);
    ...
    fun test_to_json_basic_types() {
        ...
        // Test String
        let string_value = string::utf8(b"kanari.network");
        let string_json = to_json(&string_value);
        assert!(string::utf8(string_json) == string::utf8(b"\"kanari.network\""), 5);
    ...
    fun test_to_json_composite_all() {
        ...
        let test_obj = Test {
            ...
            utf8_string: string::utf8(b"kanari.network"),
            age: 30u8,
            inner: inner,
        ...
        let map = to_map(json_str);
        assert!(simple_map::borrow(&map, &string::utf8(b"balance")) == &string::utf8(b"170141183460469231731687303715884105728"), 1);
        assert!(simple_map::borrow(&map, &string::utf8(b"utf8_string")) == &string::utf8(b"kanari.network"), 2);
        ...
        // kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd is the bech32 address of 0x42
        assert!(simple_map::borrow(&map, &string::utf8(b"account")) == &string::utf8(b"kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd"), 7);
    }
    ...
    fun test_json_address_hex_and_bech32(){
        let addr = @0x42;
        let test_address_struct = from_json<TestAddressStruct>(b"{\"addr\":\"kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd\"}");
        ...
        assert!(address_json == b"\"kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd\"", 3);
    }
}