...
#[test_only]
module kanari_framework::coin_migration_tests {
    use std::string;
    use std::option;
    ...
    use kanari_framework::coin_migration;
    use kanari_framework::genesis;
    ...
    #[test(kanari_framework = @kanari_framework)]
    fun test_account_migration_status(kanari_framework: &signer) {
        genesis::init_for_test();
        coin_migration::init_for_test();
        let onchain_config_admin = account::create_account_for_testing(onchain_config::admin());
        coin_migration::dispatch_cap_for_test(&onchain_config_admin, @kanari_framework);
        ...
        coin_migration::update_migration_state_entry(kanari_framework, ALICE);
    ...
    #[test(kanari_framework = @kanari_framework)]
    fun test_migration_with_existing_coin_stores(kanari_framework: &signer) {
        genesis::init_for_test();
        coin_migration::init_for_test();
        let onchain_config_admin = account::create_account_for_testing(onchain_config::admin());
        coin_migration::dispatch_cap_for_test(&onchain_config_admin, @kanari_framework);
        ...
        // Register coin types
        let coin1_info = register_coin<TestCoin1>(kanari_framework, b"TestCoin1", b"TC1", 8);
        ...
        coin_migration::migrate_account_entry<TestCoin1>(kanari_framework, ALICE);
        ...
        // cleanup
        object::transfer(coin1_info, @kanari_framework);
    }

    #[test(kanari_framework = @kanari_framework)]
    fun test_end_to_end_migration(kanari_framework: &signer) {
        genesis::init_for_test();
        coin_migration::init_for_test();
        let onchain_config_admin = account::create_account_for_testing(onchain_config::admin());
        coin_migration::dispatch_cap_for_test(&onchain_config_admin, @kanari_framework);
        ...
        // Register coin types
        let coin1_info = register_coin<TestCoin1>(kanari_framework, b"TestCoin1", b"TC1", 8);
        let coin2_info = register_coin<TestCoin2>(kanari_framework, b"TestCoin2", b"TC2", 6);
        ...
        coin_migration::migrate_account_entry<TestCoin1>(kanari_framework, ALICE);
        coin_migration::migrate_account_entry<TestCoin2>(kanari_framework, ALICE);
        ...
        // cleanup
        object::transfer(coin1_info, @kanari_framework);
        object::transfer(coin2_info, @kanari_framework);
    }
