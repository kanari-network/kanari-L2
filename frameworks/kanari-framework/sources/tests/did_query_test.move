...
module kanari_framework::did_query_test {
    ...
    fun test_get_did_for_address_success() {
        ...
        // Get DID by address
        let retrieved_did = did::new_kanari_did_by_address(did_address);
    ...
    fun test_get_dids_by_controller_single() {
        ...
        let controller_did = did::new_kanari_did_by_address(creator_address);
    ...
    fun test_get_dids_by_controller_string() {
        ...
        let controller_did_string = string::utf8(b"did:kanari:");
    ...
    fun test_resolve_did_object_id_deterministic() {
        ...
        let did1 = did::new_kanari_did_by_address(did_address);
        let did2 = did::new_kanari_did_by_address(did_address);
    ...
    #[test]
    /// Test controller mapping with kanari DIDs
    fun test_controller_mapping_kanari_did() {
        // Use proper setup to get creator info and DID object ID
        let (_creator_signer, creator_address, _creator_public_key_multibase, did_object_id) = did_test_common::setup_did_test_with_creation();
        ...
        // Test kanari DID controller - use creator address as controller
        let kanari_controller = did::new_kanari_did_by_address(creator_address);
        let controlled_dids = did::get_dids_by_controller(kanari_controller);
        ...
        let expected_controlled_did = did::new_kanari_did_by_address(did_address);
    ...
    fun test_query_multiple_dids_performance() {
        ...
        let did_by_address = did::new_kanari_did_by_address(did_address);
        let expected_did_string = string::utf8(b"did:kanari:");
