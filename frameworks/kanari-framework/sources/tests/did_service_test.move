...
module kanari_framework::did_service_test {
    ...
    #[test]
    #[expected_failure(abort_code = 7, location = kanari_framework::did)] // ErrorServiceAlreadyExists
    ...
    #[test]
    #[expected_failure(abort_code = 16, location = kanari_framework::did)] // ErrorPropertyKeysValuesLengthMismatch
    ...
    #[test]
    #[expected_failure(abort_code = 6, location = kanari_framework::did)] // ErrorServiceNotFound
