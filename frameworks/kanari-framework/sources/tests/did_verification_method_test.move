...
module kanari_framework::did_verification_method_test {
    ...
    #[test]
    #[expected_failure(abort_code = 5, location = kanari_framework::did)] // ErrorVerificationMethodAlreadyExists
    ...
    #[test]
    #[expected_failure(abort_code = 4, location = kanari_framework::did)] // ErrorVerificationMethodNotFound
    ...
    #[test]
    #[expected_failure(abort_code = 9, location = kanari_framework::did)] // ErrorInvalidVerificationRelationship
    ...
    #[test]
    #[expected_failure(abort_code = did::ErrorVerificationMethodAlreadyExists, location = kanari_framework::did)] // ErrorVerificationMethodAlreadyExists
