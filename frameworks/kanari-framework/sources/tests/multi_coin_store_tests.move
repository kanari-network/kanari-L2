...
#[test_only]
module kanari_framework::multi_coin_store_tests {
    use std::string;
    use std::option;
    use kanari_framework::coin::{convert_coin_to_generic_coin, register_extend};
    ...
    fun test_multi_coin_store_field_operations(account: &signer) {
        ...
        object::transfer(btc_info, @kanari_framework);
    ...
    fun test_private_coin_type(account: &signer) {
        ...
        object::transfer(private_coin_info, @kanari_framework);
    }
    ...
    fun test_multiple_coin_types(account: &signer) {
        ...
        object::transfer(btc_info, @kanari_framework);
        object::transfer(fakecoin_info, @kanari_framework);
    }
