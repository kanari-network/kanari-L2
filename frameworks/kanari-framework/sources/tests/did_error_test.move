...
module kanari_framework::did_error_test {
    ...
    #[test]
    #[expected_failure(abort_code = 22, location = kanari_framework::did)] // ErrorInvalidDIDStringFormat
    ...
    fun test_error_invalid_did_string_missing_identifier() {
        ...
        let invalid_did_string = string::utf8(b"did:kanari:");
        let _ = did::parse_did_string(&invalid_did_string);
    }
    ...
    fun test_error_invalid_did_string_wrong_prefix() {
        ...
        let invalid_did_string = string::utf8(b"wrong:kanari:identifier");
        let _ = did::parse_did_string(&invalid_did_string);
    }

    #[test]
    #[expected_failure(abort_code = did::ErrorDIDDocumentNotExist, location = kanari_framework::did)]
    ...
    #[test]
    #[expected_failure(abort_code = 13, location = kanari_framework::did)] // ErrorDIDObjectNotFound
