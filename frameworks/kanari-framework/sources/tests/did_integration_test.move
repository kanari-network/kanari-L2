...
module kanari_framework::did_integration_test {
    ...
    fun test_comprehensive_did_lifecycle() {
        ...
        let controller_did = did::new_kanari_did_by_address(_creator_address);
    ...
    fun test_cross_cutting_integration() {
        ...
        let test_did_string = string::utf8(b"did:kanari:");
    ...
    fun test_edge_cases_and_boundaries() {
        ...
        let kanari_controller = did::new_did_from_parts(string::utf8(b"kanari"), string::utf8(b"test123"));
        ...
        let kanari_controlled = did::get_dids_by_controller(kanari_controller);
        let key_controlled = did::get_dids_by_controller(key_controller);
        
        assert!(vector::length(&kanari_controlled) == 0, 15407); // No DIDs initially
