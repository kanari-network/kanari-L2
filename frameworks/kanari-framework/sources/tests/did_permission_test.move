...
module kanari_framework::did_permission_test {
    ...
    #[test]
    #[expected_failure(abort_code = 26, location = kanari_framework::did)] // ErrorInsufficientPermission
    ...
    #[test]
    #[expected_failure(abort_code = 25, location = kanari_framework::did)] // ErrorSessionKeyNotFound
