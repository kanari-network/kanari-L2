...
module kanari_framework::coin_store {
    ...
    friend kanari_framework::account_coin_store;
    friend kanari_framework::multi_coin_store;
    friend kanari_framework::coin_migration;
    ...
    // If you want to tranfer a CoinStore to another account, you can call `coin_store::remove(Object<CoinStore<CoinType>>)` and deposit the Coin<CoinType> to another account.
