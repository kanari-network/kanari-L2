...
module kanari_framework::coin_migration {
    use std::string;
    use std::vector;
    ...
    use kanari_framework::coin::{convert_coin_to_generic_coin};
    use kanari_framework::coin_store::{Self};
    use kanari_framework::multi_coin_store::{Self};
    ...
    fun initialize() {
        ...
        if(!object::exists_object(migration_state_id)){
            ...
            object::transfer_extend(migration_state, @kanari_framework);
        };
    }
