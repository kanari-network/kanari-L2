...
module kanari_framework::transfer {
    ...
    use kanari_framework::multichain_address;
    ...
    public entry fun transfer_coin_to_bitcoin_address<CoinType: key + store>(
        ...
        let kanari_address = bitcoin_address::to_kanari_address(&btc_address);
        address_mapping::bind_bitcoin_address_internal(kanari_address, btc_address);
        account_coin_store::transfer<CoinType>(from, kanari_address, amount)
    }
    ...
    public entry fun transfer_object_to_bitcoin_address<T: key + store>(
        ...
        let kanari_address = bitcoin_address::to_kanari_address(&btc_address);
        address_mapping::bind_bitcoin_address_internal(kanari_address, btc_address);
        object::transfer(obj, kanari_address);
    }
