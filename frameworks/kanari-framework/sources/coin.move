...
module kanari_framework::coin {
    ...
    friend kanari_framework::coin_store;
    ...
    entry fun init_coin_registry() {
        ...
        object::transfer_extend(coin_registry, @kanari_framework);
    }
    ...
    public fun init_for_testing() {
        let system_signer = moveos_std::account::create_signer_for_testing(@kanari_framework);
