...
module kanari_framework::onchain_config {
    ...
    friend kanari_framework::upgrade;
    ...
    public(friend) fun genesis_init(genesis_account: &signer, sequencer: address, kanari_dao: address){
        ...
        object::transfer(admin_cap, kanari_dao);
    ...
    public fun kanari_dao(): address {
        onchain_config().kanari_dao
    }
