...
module kanari_framework::auth_validator {
    use std::string;
    use std::option::{Self, Option};
    use moveos_std::tx_context;
    use kanari_framework::bitcoin_address::{Self, BitcoinAddress};

    friend kanari_framework::auth_validator_registry;
    friend kanari_framework::transaction_validator;
    friend kanari_framework::session_key;
    ...
    public fun set_simple_tx_validate_result_for_testing(session_key: Option<vector<u8>>) {
        let bitcoin_address = kanari_framework::bitcoin_address::random_address_for_testing();
