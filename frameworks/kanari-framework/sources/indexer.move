...
module kanari_framework::indexer {
    use std::signer;
    use std::string::String;
    use kanari_framework::core_addresses;
    ...
    fun init() {
        ...
        if(!object::exists_object(field_indexer_id)){
            ...
            object::transfer_extend(field_indexer_obj, @kanari_framework);
        };
    }
    ...
    public fun add_field_indexer(account: &signer, id: ObjectID, path: String, ext: String) {
        ...
        if(!core_addresses::is_kanari_genesis_address(account_addr)) {
