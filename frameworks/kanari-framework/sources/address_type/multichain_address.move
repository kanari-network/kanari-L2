...
module kanari_framework::multichain_address {

    use kanari_framework::ethereum_address::{Self, ETHAddress};
    ...
    const MULTICHAIN_ID_KANARI: u64 = 20230101; // placeholder for MULTICHAIN_ID_KANARI pending for actual id from slip-0044
    ...
    public fun multichain_id_kanari(): u64 { MULTICHAIN_ID_KANARI }
    ...
    public fun is_kanari_address(maddress: &MultiChainAddress) : bool{
        maddress.multichain_id == MULTICHAIN_ID_KANARI
    }
    ...
    public fun into_kanari_address(maddress: MultiChainAddress) : address {
        assert!(maddress.multichain_id == MULTICHAIN_ID_KANARI, ErrorMultiChainIDMismatch);
    ...
    public fun mapping_to_kanari_address(maddress: MultiChainAddress): address {
        if(is_kanari_address(&maddress)) {
            into_kanari_address(maddress)
        }else{
    ...
    #[test]
    fun test_multi_chain_address_into_kanari_address() {
