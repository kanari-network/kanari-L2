...
module kanari_framework::account_coin_store {
    use std::string;
    use kanari_framework::coin::{Coin, GenericCoin};
    use kanari_framework::coin;
    use moveos_std::type_info;
    use kanari_framework::multi_coin_store;
    use kanari_framework::multi_coin_store::MultiCoinStore;
    ...
    friend kanari_framework::account;
    ...
    public fun can_auto_accept_coin(addr: address): bool {
        let auto_accept_coins = account::borrow_resource<AutoAcceptCoins>(@kanari_framework);
    ...
    public fun set_auto_accept_coin(account: &signer, enable: bool) {
        let addr = signer::address_of(account);
        let auto_accept_coins = account::borrow_mut_resource<AutoAcceptCoins>(@kanari_framework);
