...
-  [Function `new_kanari_did_by_address`](#0x3_did_new_kanari_did_by_address)
...
<a name="0x3_did_new_kanari_did_by_address"></a>

## Function `new_kanari_did_by_address`

Create a Kanari DID struct from an address
This function only constructs a DID struct, it does NOT create a DID object on-chain


<pre><code><b>public</b> <b>fun</b> <a href="did.md#0x3_did_new_kanari_did_by_address">new_kanari_did_by_address</a>(addr: <b>address</b>): <a href="did.md#0x3_did_DID">did::DID</a>
</code></pre>
