...
crate::natives::gas_parameter::native::define_gas_parameters_for_natives!(GasParameters, "move_module", [
    ...
    [.check_compatibililty_inner.per_byte, "check_compatibililty_inner.per_byte", 20 * MUL],
    [.replace_address_identifiers.base, "replace_address_identifiers.base", 5000 * MUL],
    [.replace_address_identifiers.per_byte, "replace_address_identifiers.per_byte", 20 * MUL],
    [.replace_addresses_constant.base, "replace_addresses_constant.base", 5000 * MUL],
    [.replace_addresses_constant.per_byte, "replace_addresses_constant.per_byte", 20 * MUL],
    [.replace_identifiers.base, "replace_identifiers.base", 5000 * MUL],
    [.replace_identifiers.per_byte, "replace_identifiers.per_byte", 20 * MUL],
    [.replace_bytes_constant.base, "replace_bytes_constant.base", 5000 * MUL],
    [.replace_bytes_constant.per_byte, "replace_bytes_constant.per_byte", 20 * MUL],
    [.replace_u8_constant.base, "replace_u8_constant.base", 5000 * MUL],
    [.replace_u8_constant.per_byte, "replace_u8_constant.per_byte", 20 * MUL],
    [.replace_u64_constant.base, "replace_u64_constant.base", 5000 * MUL],
    [.replace_u64_constant.per_byte, "replace_u64_constant.per_byte", 20 * MUL],
    [.replace_u256_constant.base, "replace_u256_constant.base", 5000 * MUL],
    [.replace_u256_constant.per_byte, "replace_u256_constant.per_byte", 20 * MUL],
]);
