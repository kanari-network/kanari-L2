...
impl ObjectID {
    ...
    /// Creates a new ObjectID with path
    pub fn new_with_path(path: Vec<AccountAddress>) -> Self {
        Self(path)
    }
...
mod tests {
    ...
    fn test_named_object_id() {
        ...
        //The object id generated by crates/kanari-framework-tests/tests/cases/timestamp/timestamp_test.move
    ...
    fn test_account_named_object_id() {
        ...
        let struct_tag = StructTag {
            ...
            type_params: vec![TypeTag::Struct(Box::new(StructTag {
                ...
                name: ident_str!("RGas").to_owned(),
                type_params: vec![],
            }))],
        };
        let coin_store_object_id = account_named_object_id(account, &struct_tag);
        //The object id generated by crates/kanari-framework-tests/tests/cases/coin_store/coin_store.move
        let object_id = ObjectID::from_str(
            "0x562409111a2ca55814e56eb42186470c4adda4a04a4a84140690f4d68e8e1c06",
        )
        .unwrap();
    ...
    #[test]
    fn test_module_store_named_object_id() {
        let struct_tag = StructTag {
            address: AccountAddress::from_str("0x2").unwrap(),
            module: ident_str!("module_store").to_owned(),
            name: ident_str!("ModuleStore").to_owned(),
            type_params: vec![],
        };
        let module_store_object_id = named_object_id(&struct_tag);
        //The object id generated by crates/kanari-framework-tests/tests/cases/module/module_test.move
        let object_id = ObjectID::from_str(
            "0x14481947570f6c2f50d190f9a13bf549ab2f0c9debc41296cd4d506002379659",
        )
        .unwrap();
        assert_eq!(module_store_object_id, object_id,);
    }
    ...
    fn test_custom_object_id() {
        ...
        assert_eq!(
            custom_object_id,
            ObjectID::from_str(
                "0x6c62fde28fadbe652ba0eec95f5f096c900c94191a2debca96276b2de4b6ee3a"
            )
            .unwrap()
        );
    }
    ...
    fn test_json_object_id() {
        ...
        //The object id generated by frameworks/moveos-stdlib/source/json.move#test_json_object
        let json_object_id_str = "0xa7afe75c4f3a7631191905601f4396b25dde044539807de65ed4fc7358dbd98e922b7bfcb1937ef58a03e80216493fff916d18cddc747b7a1fb93ce631ee9c62";
        let json_object_id = ObjectID::from_str(json_object_id_str).unwrap();
        assert_eq!(json_object_id_str, json_object_id.to_string());
    }
}
