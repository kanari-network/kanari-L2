...
pub const KANARI_HRP: Hrp = Hrp::parse_unchecked("kanari");
...
pub fn to_bech32(addr: &AccountAddress) -> Result<String> {
    bech32::encode::<Bech32m>(KANARI_HRP, addr.into_bytes().as_slice())
...
pub fn from_bech32(bech32: &str) -> Result<AccountAddress> {
    ...
    anyhow::ensure!(hrp == KANARI_HRP, "invalid account address hrp");
    anyhow::ensure!(
...
mod tests {
    ...
    fn test_address_bech32() {
        ...
        assert_eq!(
            addr_bech32_str,
            "kanari1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqppq6exstd"
        );
        ...
        assert_eq!(
            addr_bech32_str2,
            "kanari157h7whz08fmrzxgeq4sp7sukkfwaupz98xq8mej76n78xkxmmx8q9ujmg6"
        );
