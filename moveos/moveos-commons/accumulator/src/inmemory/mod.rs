...
impl InMemoryAccumulator {
    ...
    /// returned.
    pub fn append(&self, leaves: &[H256]) -> Self {
    ...
    fn append_one(frozen_subtree_roots: &mut Vec<H256>, num_existing_leaves: u64, leaf: H256) {
    ...
    /// ```
    pub fn append_subtrees(&self, subtrees: &[H256], num_new_leaves: u64) -> Result<Self> {
        ensure!(
    ...
    fn compute_root_hash(frozen_subtree_roots: &[H256], num_leaves: u64) -> H256 {
    ...
    pub fn frozen_subtree_roots(&self) -> &Vec<H256> {
