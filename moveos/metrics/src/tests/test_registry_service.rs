...
fn registry_service() {
    ...
    let registry_2 = Registry::new_custom(Some("kanari".to_string()), None).unwrap();
    registry_2
        .register(Box::new(
    ...
    assert_eq!(metric_2.get_name(), "kanari_counter_2");
    ...
    let metric_1 = metrics.remove(0);
    assert_eq!(metric_1.get_name(), "kanari_counter_2");
